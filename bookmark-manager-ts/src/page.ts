...
document.addEventListener("DOMContentLoaded", () => {
    ...
    bookmarkList.addEventListener("click", (event: Event) => {
        ...
        const editButton = targetElement.closest(".edit-btn") as HTMLElement | null; // Ensures that you're detecting the correct button even if an inner element (like an icon) is clicked.
